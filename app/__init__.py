...
def preset():
    db.create_movie("tt0389790", 'The Bee Movie', 2007, 'Fresh out of college, Barry the Bee finds the prospect of working with honey uninspiring. He flies outside the hive for the first time and talks to a human, breaking a cardinal rule of his species. Barry learns that humans have been stealing and eating honey for centuries, and he realizes that his true calling is to obtain justice for his kind by suing humanity for theft.', '6.1', "Netflix" ,'https://www.youtube.com/watch?v=VONRQMx78YI', 'https://resizing.flixster.com/18icyRbPRhjrgvKB_7-9Z8lNrI0=/ems.cHJkLWVtcy1hc3NldHMvbW92aWVzLzA0MzljODE3LTgzMDMtNGRiOS1iOTM0LTM1ODk1ODMwNDIyOC53ZWJw')
    db.create_movie('tt0108255', 'The Super Mario Bros. Movie', 2023, 'Mario make his first arrival to the Mushroom Kingdom, where a stranger from another land magically teleports into another unfamiliar world for adventure.', 'N/A', 'Yet to be released', 'https://www.youtube.com/watch?v=TnGl01FkMMo', 'https://m.media-amazon.com/images/M/MV5BYjY5MTYwMDYtNDk4OS00NmE1LWI2ZjItY2Q5ZmVmNTU4NTAyXkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_FMjpg_UX1000_.jpg')
    db.create_movie('tt6226232', 'Young Sheldon', 2017, 'Meet a child genius named Sheldon Cooper (already seen as an adult in The Big Bang Theory (2007)) and his family. Some unique challenges face Sheldon, who is socially impaired.', '7.6', 'Netflix', 'https://www.youtube.com/watch?v=YsGmUhjvqSo', 'https://m.media-amazon.com/images/M/MV5BZDg3MGNhYjItZGU2Yi00MzU4LWE4NGUtYjA2OTVjNGUyMjE4XkEyXkFqcGdeQXVyNjg4NzAyOTA@._V1_FMjpg_UX1000_.jpg')
    db.create_movie('tt5108870', 'Morbius', 2022, 'Biochemist Michael Morbius tries to cure himself of a rare blood disease, but he inadvertently infects himself with a form of vampirism instead.', '5.2', 'Netflix', 'https://www.youtube.com/watch?v=oZ6iiRrz1SY' , 'https://www.sonypictures.com/sites/default/files/styles/max_560x840/public/title-key-art/morbius_onesheet_1400x2100_he.jpg?itok=-jQVkWIe')
    db.create_movie('tt2294629', 'Frozen', 2013, 'When the newly crowned Queen Elsa accidentally uses her power to turn things into ice to curse her home in infinite winter, her sister Anna teams up with a mountain man, his playful reindeer, and a snowman to change the weather condition.', '7.4','Netflix', 'https://www.youtube.com/watch?v=TbQm5doF_Uc' , 'https://m.media-amazon.com/images/M/MV5BNzE1OTkwOTkwMV5BMl5BanBnXkFtZTgwNTcwMDk4NTE@._V1_.jpg')
